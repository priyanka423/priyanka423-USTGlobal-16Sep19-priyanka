...
public class LibrarianController {
	...
	public LibrarianResponse addBookInventory(@RequestBody BookInventoryBean bookInventory) throws LibraryManagementException {
		try {
		...
		return response;
			...
			throw new LibraryManagementException("failed");
		}
	}
	...
	@PutMapping(path="/book/update",
			consumes = MediaType.APPLICATION_JSON_VALUE,
			produces = MediaType.APPLICATION_JSON_VALUE)
	public LibrarianResponse updateBookInventory(@RequestBody BookInventoryBean bookInventory) throws LibraryManagementException {
		LibrarianResponse response=new LibrarianResponse();
		try {
	...
	throw new LibraryManagementException("msg");
}
	}
	
	@DeleteMapping(path="/book/delete/{book_inventory_id}",
			produces = MediaType.APPLICATION_JSON_VALUE)
	public LibrarianResponse deleteBookInventory(@PathVariable("book_inventory_id") int book_inventory_id) throws LibraryManagementException { 
		LibrarianResponse response=new LibrarianResponse();
		try {
	...
	@GetMapping(path="/book/getList",
			produces = MediaType.APPLICATION_JSON_VALUE)
	public LibrarianResponse getAll() throws LibraryManagementException{
		LibrarianResponse response=new LibrarianResponse();
	...
	@GetMapping(path="/book/get",
			produces = MediaType.APPLICATION_JSON_VALUE)
	public LibrarianResponse getBookData(@RequestParam("book_inventory_id") int book_inventory_id) throws LibraryManagementException {
		LibrarianResponse response=new LibrarianResponse();
