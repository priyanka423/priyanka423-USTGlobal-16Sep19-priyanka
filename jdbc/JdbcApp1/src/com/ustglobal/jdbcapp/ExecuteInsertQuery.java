...
public class ExecuteInsertQuery {
	public static void main(String[] args) {
		...
		try {
			...
			//	String sql="insert into employee_info"   // concatinates the two lines so used + oerator
			//			+"values(7,'priya',10000,'f')";
			String sql="insert into employee_info values(7,'priya',10000,'f')";
